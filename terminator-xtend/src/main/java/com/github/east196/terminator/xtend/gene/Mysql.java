...
public class Mysql {
  public static void main(final String[] args) {
    ...
    _builder.append("E:\\backup\\xcode\\统一数据文档20181206.doc");
    ...
    final Consumer<Three> _function = (Three three) -> {
      ...
      Mysql.gene(_project, _record, _fields);
  ...
  public static void gene(final Project project, final Record record, final List<Field> fields) {
    ...
    CharSequence content = Mysql.bean(project, record, fields);
    StringConcatenation _builder = new StringConcatenation();
    ...
    CharSequence _dao = Mysql.dao(project, record, fields);
    content = _dao;
    ...
    InputOutput.<String>println(path);
    Bots.copy(content, path);
    CharSequence _controller = Mysql.controller(project, record, fields);
    content = _controller;
    ...
    InputOutput.<String>println(path);
    Bots.copy(content, path);
    CharSequence _validator = Mysql.validator(project, record, fields);
    content = _validator;
    ...
    InputOutput.<String>println(path);
    Bots.copy(content, path);
    CharSequence _tableHtml = Mysql.tableHtml(project, record, fields);
    content = _tableHtml;
    ...
    InputOutput.<String>println(path);
    Bots.copy(content, path);
    CharSequence _js = Mysql.js(project, record, fields);
    content = _js;
    ...
    InputOutput.<String>println(path);
    Bots.copy(content, path);
    CharSequence _controllerTxt = Mysql.controllerTxt(project, record, fields);
  ...
  public static CharSequence bean(final Project project, final Record record, final List<Field> fields) {
    CharSequence _xblockexpression = null;
    {
      ...
      List<String> _map = ListExtensions.<Field, String>map(fields, _function);
      ...
      List<String> _map_1 = ListExtensions.<Field, String>map(fields, _function_1);
