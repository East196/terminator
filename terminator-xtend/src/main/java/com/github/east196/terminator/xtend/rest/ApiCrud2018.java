...
public class ApiCrud2018 {
  ...
  public static class Valid {
    ...
    public static ApiCrud2018.Valid from(final String validStr) {
      return Boon.<ApiCrud2018.Valid>fromJson(validStr, ApiCrud2018.Valid.class);
    }
  ...
  public static void main(final String[] args) {
    ...
    _builder.append("E:\\backup\\xcode\\统一数据文档 Pro.doc");
    ...
    final Consumer<Three> _function_1 = (Three three) -> {
      ApiCrud2018.geneAll(three);
    };
    _filter.forEach(_function_1);
  }
  
  public static ApiCrud2018.Valid toValid(final String validStr) {
    return ApiCrud2018.Valid.from(validStr);
  }
  
  public static String toJson(final ApiCrud2018.Valid valid) {
    return Boon.toPrettyJson(valid);
  }
  
  public static void geneAll(final Three three) {
    GeneResult _gene = ApiCrud2018.gene(three, "entity");
    _gene.copy();
    GeneResult _gene_1 = ApiCrud2018.gene(three, "bean");
    _gene_1.copy();
    GeneResult _gene_2 = ApiCrud2018.gene(three, "crudservice");
    _gene_2.copy();
    GeneResult _gene_3 = ApiCrud2018.gene(three, "crudserviceimpl");
    _gene_3.copy();
    GeneResult _gene_4 = ApiCrud2018.gene(three, "service");
    _gene_4.copy();
    GeneResult _gene_5 = ApiCrud2018.gene(three, "serviceimpl");
    _gene_5.copy();
    GeneResult _gene_6 = ApiCrud2018.gene(three, "dao");
    _gene_6.copy();
    GeneResult _gene_7 = ApiCrud2018.gene(three, "customdao");
    _gene_7.copy();
    GeneResult _gene_8 = ApiCrud2018.gene(three, "customdaoimpl");
    _gene_8.copy();
    GeneResult _gene_9 = ApiCrud2018.gene(three, "controller");
    _gene_9.copy();
    GeneResult _gene_10 = ApiCrud2018.gene(three, "coustomcontroller");
    _gene_10.copy();
    GeneResult _gene_11 = ApiCrud2018.gene(three, "restcli");
    _gene_11.copy();
  }
  ...
  public static GeneResult gene(final Three three, final String type) {
    ...
    switch (type) {
      case "bean":
        CharSequence _bean = ApiCrud2018.bean(project, record, fields);
        content = _bean;
        StringConcatenation _builder = new StringConcatenation();
        String _path = project.getPath();
        _builder.append(_path, "");
        _builder.append("\\src\\main\\android\\");
        ...
        break;
      case "entity":
        CharSequence _entity = ApiCrud2018.entity(project, record, fields);
        content = _entity;
        ...
        break;
      case "dao":
        CharSequence _dao = ApiCrud2018.dao(project, record, fields);
        content = _dao;
        ...
        break;
      case "customdao":
        CharSequence _customdao = ApiCrud2018.customdao(project, record, fields);
        content = _customdao;
        ...
        _builder_3.append("\\customdao\\Customized");
        ...
        break;
      case "customdaoimpl":
        CharSequence _customdaoimpl = ApiCrud2018.customdaoimpl(project, record, fields);
        ...
        _builder_4.append("\\customdaoimpl\\Customized");
        String _name_5 = record.getName();
        String _firstUpper_4 = StringExtensions.toFirstUpper(_name_5);
        _builder_4.append(_firstUpper_4, "");
        _builder_4.append("RepositoryImpl.java");
        path = _builder_4;
        break;
      case "controller":
        CharSequence _controller = ApiCrud2018.controller(project, record, fields);
        content = _controller;
        ...
        _builder_5.append("\\controller\\");
        String _name_6 = record.getName();
        String _firstUpper_5 = StringExtensions.toFirstUpper(_name_6);
        _builder_5.append(_firstUpper_5, "");
        _builder_5.append("CrudController.java");
        path = _builder_5;
        break;
      case "restcli":
        CharSequence _restcli = ApiCrud2018.restcli(project, record, fields);
        content = _restcli;
      ...
      case "service":
        ...
        _builder_7.append("\\service\\");
        String _name_8 = record.getName();
        String _firstUpper_7 = StringExtensions.toFirstUpper(_name_8);
        _builder_7.append(_firstUpper_7, "");
        _builder_7.append("Service.java");
        path = _builder_7;
        break;
      case "serviceimpl":
        CharSequence _ServiceImpl = ApiCrud2018.ServiceImpl(project, record, fields);
        ...
        _builder_8.append("\\serviceimpl\\");
        String _name_9 = record.getName();
        String _firstUpper_8 = StringExtensions.toFirstUpper(_name_9);
        _builder_8.append(_firstUpper_8, "");
        _builder_8.append("ServiceImpl.java");
        path = _builder_8;
        break;
      case "crudservice":
        CharSequence _CrudService = ApiCrud2018.CrudService(project, record, fields);
        ...
        _builder_9.append("\\crudservice\\");
        String _name_10 = record.getName();
        String _firstUpper_9 = StringExtensions.toFirstUpper(_name_10);
        _builder_9.append(_firstUpper_9, "");
        _builder_9.append("CrudService.java");
        path = _builder_9;
        break;
      case "crudserviceimpl":
        CharSequence _CrudServiceImpl = ApiCrud2018.CrudServiceImpl(project, record, fields);
        ...
        _builder_10.append("\\crudserviceimpl\\");
        ...
        _builder_10.append("CrudServiceImpl.java");
        path = _builder_10;
        break;
      case "coustomcontroller":
        CharSequence _CoustomCon1troller = ApiCrud2018.CoustomCon1troller(project, record, fields);
        ...
        _builder_11.append("\\coustomcontroller\\");
        ...
        _builder_11.append("CoustomController.java");
        path = _builder_11;
        break;
      default:
        {
          ...
          CharSequence _entity_1 = ApiCrud2018.entity(_project, _record, _fields);
          content = _entity_1;
          StringConcatenation _builder_12 = new StringConcatenation();
          String _path_12 = project.getPath();
          _builder_12.append(_path_12, "");
          _builder_12.append("\\src\\main\\java\\");
          _builder_12.append(javaPath, "");
          _builder_12.append("\\entity\\");
          String _name_13 = record.getName();
          String _firstUpper_12 = StringExtensions.toFirstUpper(_name_13);
          _builder_12.append(_firstUpper_12, "");
          _builder_12.append(".java");
          path = _builder_12;
        }
        break;
    }
  ...
  public static CharSequence CoustomCon1troller(final Project project, final Record record, final List<Field> fields) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.append(klassType, "\t\t");
      _builder.append("CoustomController.class);");
      _builder.newLineIfNotEmpty();
      _builder.append("\t");
      _builder.newLine();
      _builder.append("\t\t");
  ...
  public static CharSequence ServiceImpl(final Project project, final Record record, final List<Field> fields) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.append("import ");
      _builder.append(basePackageName, "");
      _builder.append(".crudserviceimpl.*;");
      _builder.newLineIfNotEmpty();
      _builder.newLine();
      _builder.append("@Service");
      _builder.newLine();
  ...
  public static CharSequence CrudServiceImpl(final Project project, final Record record, final List<Field> fields) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.append("\t\t         \t  ");
      _builder.append("saveInfo= ");
      String _firstLower_12 = StringExtensions.toFirstLower(daoType);
      ...
      _builder.append(" = ");
      String _firstLower_14 = StringExtensions.toFirstLower(daoType);
      ...
      _builder.append("\t\t            ");
      _builder.append("saveInfo= ");
      String _firstLower_18 = StringExtensions.toFirstLower(daoType);
      ...
      _builder.append("=");
      String _firstLower_20 = StringExtensions.toFirstLower(daoType);
    ...
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLineIfNotEmpty();
      {
        for(final Field f_1 : fields) {
          _builder.append("\t");
          _builder.append("/**");
          String _doc = f_1.getDoc();
          _builder.append(_doc, "\t");
          _builder.append("**/");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("private ");
          String _javaType = f_1.javaType();
        ...
        for(final Field f_1 : fields) {
          ...
          _builder.newLineIfNotEmpty();
          {
            ...
            if (_equals) {
              ...
              boolean _equals_1 = Objects.equal(_keyType_1, "M21");
              if (_equals_1) {
                ...
                String _keyType_2 = f_1.getKeyType();
                boolean _equals_2 = Objects.equal(_keyType_2, "12M");
                if (_equals_2) {
                  ...
                  String _keyType_3 = f_1.getKeyType();
                  boolean _equals_3 = Objects.equal(_keyType_3, "121");
                  if (_equals_3) {
          ...
          }
          {
            ...
            boolean _equals_4 = Objects.equal(_type, "date");
            if (_equals_4) {
          ...
          }
          {
            ...
            ApiCrud2018.Valid _valid_1 = ApiCrud2018.toValid(_valid);
            boolean _requried = _valid_1.getRequried();
            boolean _equals_6 = (_requried == true);
            if (_equals_6) {
              {
                String _javaType = f_1.javaType();
                boolean _equals_7 = Objects.equal(_javaType, "List");
                if (_equals_7) {
                  _builder.append("@NotEmpty(message =\"");
                  String _doc_1 = f_1.getDoc();
          ...
          }
          {
            ...
            ApiCrud2018.Valid _valid_3 = ApiCrud2018.toValid(_valid_2);
            String _valid_4 = _valid_3.getValid();
            boolean _equals_8 = Objects.equal(_valid_4, "cname");
            if (_equals_8) {
              _builder.append("@Pattern(regexp = Validators.REGEX_CHINESE_LENGTH ,message = \"姓名应当使用汉字！并且长度应当在2至8个汉字之间！\")");
              _builder.newLine();
            } else {
              String _valid_5 = f_1.getValid();
              ApiCrud2018.Valid _valid_6 = ApiCrud2018.toValid(_valid_5);
              String _valid_7 = _valid_6.getValid();
              boolean _equals_9 = Objects.equal(_valid_7, "ename");
              if (_equals_9) {
                ...
                ApiCrud2018.Valid _valid_9 = ApiCrud2018.toValid(_valid_8);
                String _valid_10 = _valid_9.getValid();
                boolean _equals_10 = Objects.equal(_valid_10, "name");
                if (_equals_10) {
                  ...
                  ApiCrud2018.Valid _valid_12 = ApiCrud2018.toValid(_valid_11);
                  String _valid_13 = _valid_12.getValid();
                  boolean _equals_11 = Objects.equal(_valid_13, "address");
                  if (_equals_11) {
                    ...
                    ApiCrud2018.Valid _valid_15 = ApiCrud2018.toValid(_valid_14);
                    String _valid_16 = _valid_15.getValid();
                    boolean _equals_12 = Objects.equal(_valid_16, "phone");
                    if (_equals_12) {
                      _builder.append("@Pattern(regexp = Validators.REGEX_MOBILE ,message = \"手机号码格式不对！\")");
                      _builder.newLine();
                    } else {
                      String _valid_17 = f_1.getValid();
                      ApiCrud2018.Valid _valid_18 = ApiCrud2018.toValid(_valid_17);
                      String _valid_19 = _valid_18.getValid();
                      boolean _equals_13 = Objects.equal(_valid_19, "password");
                      if (_equals_13) {
                        ...
                        ApiCrud2018.Valid _valid_21 = ApiCrud2018.toValid(_valid_20);
                        String _valid_22 = _valid_21.getValid();
                        boolean _equals_14 = Objects.equal(_valid_22, "path");
                        if (_equals_14) {
  ...
  public static CharSequence customdao(final Project project, final Record record, final List<Field> fields) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.append("package ");
      _builder.append(basePackageName, "");
      _builder.append(".customdao;");
      _builder.newLineIfNotEmpty();
      _builder.newLine();
      _builder.append("import java.util.List;");
      _builder.newLine();
      _builder.newLine();
      _builder.append("public interface Customized");
  ...
  public static CharSequence customdaoimpl(final Project project, final Record record, final List<Field> fields) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLineIfNotEmpty();
      _builder.newLine();
      _builder.append("public class Customized");
      _builder.append(daoType, "");
  ...
  public static CharSequence controller(final Project project, final Record record, final List<Field> fields) {
    CharSequence _xblockexpression = null;
    {
      ...
      String _name_2 = record.getName();
      String _firstUpper_1 = StringExtensions.toFirstUpper(_name_2);
      String klassType = (_firstUpper_1 + "CrudController");
      String _name_3 = record.getName();
      ...
      _builder.append("@RestController");
      _builder.newLine();
      _builder.append("@RequestMapping(\"/crud/v1/");
