...
public class AntDVue2018 {
  ...
  public static void geneAll(final Three three) {
    GeneResult _gene = AntDVue2018.gene(three, "list");
    _gene.copy();
    GeneResult _gene_1 = AntDVue2018.gene(three, "search");
    _gene_1.copy();
  }
  ...
  public static GeneResult gene(final Three three, final String type) {
    ...
    switch (type) {
      case "list":
        CharSequence _recordlist = AntDVue2018.recordlist(project, record, fields);
        content = _recordlist;
        ...
        break;
      case "search":
        CharSequence _recordsearch = AntDVue2018.recordsearch(project, record, fields);
  ...
  public static CharSequence recordlist(final Project project, final Record record, final List<Field> fields) {
    CharSequence _xblockexpression = null;
    {
        ...
        for(final Field f_1 : fields) {
          {
            ...
            if (_equals) {
              ...
              if ((Objects.equal(f_1.getKeyType(), "M21") || Objects.equal(f_1.getKeyType(), "121"))) {
                ...
                _builder.newLine();
                {
                  String _required = f_1.getRequired();
                ...
                if (_equals_2) {
                  ...
                  if (_equals_3) {
                    ...
                    _builder.newLine();
                    {
                      String _required_1 = f_1.getRequired();
                      boolean _equals_4 = Objects.equal(_required_1, "required");
                      if (_equals_4) {
                        _builder.append("\t\t  ");
                        _builder.append("{ required: true, message: \'请输入");
                    ...
                    if (_equals_5) {
                      ...
                      _builder.newLine();
                      {
                        String _required_2 = f_1.getRequired();
                        boolean _equals_6 = Objects.equal(_required_2, "required");
                        if (_equals_6) {
                          _builder.append("\t\t  ");
                          _builder.append("{ required: true, message: \'请输入");
                      ...
                      _builder.newLine();
                      {
                        String _required_3 = f_1.getRequired();
                        boolean _equals_7 = Objects.equal(_required_3, "required");
                        if (_equals_7) {
                          _builder.append("  ");
                          _builder.append("{ required: true, message: \'请输入");
        ...
        for(final Field f_3 : fields) {
          {
            ...
            boolean _equals_8 = Objects.equal(_keyType_2, "P");
            if (_equals_8) {
            } else {
              String _keyType_3 = f_3.getKeyType();
              boolean _equals_9 = Objects.equal(_keyType_3, "12M");
              if (_equals_9) {
              } else {
                if ((Objects.equal(f_3.getKeyType(), "M21") || Objects.equal(f_3.getKeyType(), "121"))) {
                  ...
                  boolean _equals_10 = Objects.equal(_type_2, "datetime");
                  if (_equals_10) {
                    _builder.append("{");
                    _builder.newLine();
                    _builder.append("  ");
                    _builder.append("title: \"");
                    String _label_10 = f_3.getLabel();
                    ...
                    boolean _equals_11 = Objects.equal(_type_3, "date");
                    if (_equals_11) {
                      _builder.append("{");
                      _builder.newLine();
                      _builder.append("  ");
                      _builder.append("title: \"");
                      String _label_11 = f_3.getLabel();
        ...
        for(final Field f_5 : fields) {
          {
            ...
            boolean _equals_12 = Objects.equal(_keyType_4, "12M");
            if (_equals_12) {
              _builder.append("      ");
      ...
      String _label_13 = record.getLabel();
      ...
      String _label_14 = record.getLabel();
