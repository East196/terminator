...
public class Api2018 {
  ...
  public static class HttpReqResp {
    ...
    public boolean equals(final Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      Api2018.HttpReqResp other = (Api2018.HttpReqResp) obj;
  ...
  public static void main(final String[] args) {
    ...
    _builder.append("E:\\backup\\xcode\\API_ADMIN_NEW.doc");
  ...
  public static void gene(final String src) {
    ...
    final Three projectThree = Api2018.table2project(projecttable);
    final Consumer<Table> _function_3 = (Table table) -> {
      final Three three = Api2018.table2data(projectThree, table);
      Project _project = projectThree.getProject();
      three.setProject(_project);
      GeneResult _threeEntityGene = Api2018.threeEntityGene(three);
      _threeEntityGene.copy();
    };
    datatables.forEach(_function_3);
    final Function1<Table, Api2018.HttpReqResp> _function_4 = (Table table) -> {
      Api2018.HttpReqResp _xblockexpression = null;
      {
        ...
        Project _project = projectThree.getProject();
        final Api2018.HttpReqResp rest = Api2018.table2rest(_project, table);
        _xblockexpression = rest;
      }
      return _xblockexpression;
    };
    Iterable<Api2018.HttpReqResp> _map = IterableExtensions.<Table, Api2018.HttpReqResp>map(resttables, _function_4);
    final List<Api2018.HttpReqResp> httpReqResps = IterableExtensions.<Api2018.HttpReqResp>toList(_map);
    final Consumer<Api2018.HttpReqResp> _function_5 = (Api2018.HttpReqResp rest) -> {
      Three project = rest.project;
      Three headers = rest.headers;
      Api2018.geneEntity(headers, project);
      Three params = rest.params;
      Api2018.geneEntity(params, project);
      Three reqBody = rest.reqBody;
      Api2018.geneEntity(reqBody, project);
      Three respBody = rest.respBody;
      Api2018.geneEntity(respBody, project);
    };
    ...
    CharSequence content = Api2018.controller(projectThree, httpReqResps);
    StringConcatenation _builder = new StringConcatenation();
    ...
    _geneResult.copy();
    CharSequence _service = Api2018.service(projectThree, httpReqResps);
    content = _service;
    ...
    _geneResult_1.copy();
    CharSequence _retrofit2 = Api2018.retrofit2(projectThree, httpReqResps);
    content = _retrofit2;
    ...
    _geneResult_2.copy();
    CharSequence _retrofit2remote = Api2018.retrofit2remote(projectThree, httpReqResps);
    ...
    _geneResult_3.copy();
    CharSequence _feign = Api2018.feign(projectThree, httpReqResps);
    content = _feign;
    ...
    _geneResult_4.copy();
    CharSequence _client = Api2018.client(projectThree, httpReqResps);
    content = _client;
    ...
    _geneResult_5.copy();
    CharSequence _android = Api2018.android(projectThree, httpReqResps);
    content = _android;
    ...
    _builder_6.append("Android.java");
    path = _builder_6.toString();
    GeneResult _geneResult_6 = new GeneResult(content, path);
    _geneResult_6.copy();
    CharSequence _axoisapi = Api2018.axoisapi(projectThree, httpReqResps);
    content = _axoisapi;
    ...
    _builder_7.append("\\index.js");
    path = _builder_7.toString();
    GeneResult _geneResult_7 = new GeneResult(content, path);
    _geneResult_7.copy();
    CharSequence _axoisapi2 = Api2018.axoisapi2(projectThree, httpReqResps);
    content = _axoisapi2;
    ...
    _builder_8.append("\\api.js");
    path = _builder_8.toString();
    GeneResult _geneResult_8 = new GeneResult(content, path);
    _geneResult_8.copy();
  }
  ...
  protected static void geneEntity(final Three part, final Three project) {
    ...
    if (_greaterThan) {
      ...
      GeneResult _threeEntityGene = Api2018.threeEntityGene(part);
      _threeEntityGene.copy();
    }
  }
  ...
  protected static CharSequence threeEntityContent(final Three three) {
    CharSequence _xblockexpression = null;
    {
      ...
      CharSequence content = Api2018.entity(project, record, fields);
  ...
  protected static GeneResult threeEntityGene(final Three three) {
    ...
    {
      CharSequence content = Api2018.threeEntityContent(three);
      CharSequence path = Api2018.threeEntityPath(three);
  ...
  public static Api2018.HttpReqResp table2rest(final Project projectInfo, final Table table) {
    Api2018.HttpReqResp _xblockexpression = null;
    {
      Three project = Api2018.threeFrom(projectInfo, table);
      Three headers = Api2018.threeFrom(table, "Headers");
      Three params = Api2018.threeFrom(table, "Params");
      Three reqBody = Api2018.threeFrom(table, "ReqBody");
      Three reqBodyEntity = Api2018.threeFrom(table, "请求体");
      Three respBody = Api2018.threeFrom(table, "RespBody");
      Three respBodyEntity = Api2018.threeFrom(table, "响应体");
      _xblockexpression = new Api2018.HttpReqResp(project, headers, params, reqBody, reqBodyEntity, respBody, respBodyEntity);
    }
    return _xblockexpression;
  }
  ...
  public static Three threeFrom(final Project project, final Table table) {
    ...
    {
      Record record = Api2018.recordFrom(table);
  ...
  public static Three threeFrom(final Table table, final String type) {
    Three _xblockexpression = null;
    {
      ...
      List<Field> _fieldsFrom = Api2018.fieldsFrom(table, type);
  ...
  public static CharSequence retrofit2remote(final Three projectThree, final List<Api2018.HttpReqResp> httpReqResps) {
    CharSequence _xblockexpression = null;
    {
      Project _project = projectThree.getProject();
      String _name = _project.getName();
  ...
  public static CharSequence retrofit2(final Three projectThree, final List<Api2018.HttpReqResp> httpReqResps) {
    CharSequence _xblockexpression = null;
    {
      Project _project = projectThree.getProject();
      String _name = _project.getName();
      ...
      _builder.newLine();
      {
        final Function1<Api2018.HttpReqResp, Boolean> _function = (Api2018.HttpReqResp it) -> {
          Record _record = it.respBody.getRecord();
          String _method = _record.getMethod();
          return Boolean.valueOf(_method.equalsIgnoreCase("GET"));
        };
        boolean _exists = IterableExtensions.<Api2018.HttpReqResp>exists(httpReqResps, _function);
        if (_exists) {
      ...
      _builder.newLineIfNotEmpty();
      {
        final Function1<Api2018.HttpReqResp, Boolean> _function_1 = (Api2018.HttpReqResp it) -> {
          Record _record = it.respBody.getRecord();
          String _method = _record.getMethod();
          return Boolean.valueOf(_method.equalsIgnoreCase("POST"));
        };
        boolean _exists_1 = IterableExtensions.<Api2018.HttpReqResp>exists(httpReqResps, _function_1);
        if (_exists_1) {
      ...
      _builder.newLineIfNotEmpty();
      {
        final Function1<Api2018.HttpReqResp, Boolean> _function_2 = (Api2018.HttpReqResp it) -> {
          Record _record = it.respBody.getRecord();
          String _method = _record.getMethod();
          return Boolean.valueOf(_method.equalsIgnoreCase("DELETE"));
        };
        boolean _exists_2 = IterableExtensions.<Api2018.HttpReqResp>exists(httpReqResps, _function_2);
        if (_exists_2) {
      ...
      _builder.newLine();
      {
        for(final Api2018.HttpReqResp http : httpReqResps) {
          _builder.append("/** ");
  ...
  public static CharSequence feign(final Three projectThree, final List<Api2018.HttpReqResp> httpReqResps) {
    CharSequence _xblockexpression = null;
    {
      Project _project = projectThree.getProject();
      String _name = _project.getName();
  ...
  public static CharSequence client(final Three projectThree, final List<Api2018.HttpReqResp> httpReqResps) {
    CharSequence _xblockexpression = null;
    {
      Project _project = projectThree.getProject();
      String _name = _project.getName();
  ...
  public static CharSequence controller(final Three projectThree, final List<Api2018.HttpReqResp> httpReqResps) {
    CharSequence _xblockexpression = null;
    {
      Project _project = projectThree.getProject();
      String _name = _project.getName();
  ...
  public static CharSequence service(final Three projectThree, final List<Api2018.HttpReqResp> httpReqResps) {
    CharSequence _xblockexpression = null;
    {
      Project _project = projectThree.getProject();
      String _name = _project.getName();
  ...
  public static CharSequence android(final Three projectThree, final List<Api2018.HttpReqResp> httpReqResps) {
    CharSequence _xblockexpression = null;
    {
      Project _project = projectThree.getProject();
      String _name = _project.getName();
      String _firstUpper = StringExtensions.toFirstUpper(_name);
      final String HttpsName = (_firstUpper + "Android");
      Project _project_1 = projectThree.getProject();
      final String basePath = _project_1.getPath();
      Project _project_2 = projectThree.getProject();
      String _root = _project_2.getRoot();
      String[] _split = _root.split("\\.");
      final String javaPath = IterableExtensions.join(((Iterable<?>)Conversions.doWrapArray(_split)), "\\");
      Project _project_3 = projectThree.getProject();
      String _name_1 = _project_3.getName();
      String packageName = StringExtensions.toFirstLower(_name_1);
      Project _project_4 = projectThree.getProject();
      final String basePackageName = _project_4.getRoot();
      Project _project_5 = projectThree.getProject();
      String _root_1 = _project_5.getRoot();
      String[] _split_1 = _root_1.split("\\.");
      Project _project_6 = projectThree.getProject();
      String _root_2 = _project_6.getRoot();
      String[] _split_2 = _root_2.split("\\.");
      int _length = _split_2.length;
      int _minus = (_length - 1);
      List<String> _subList = ((List<String>)Conversions.doWrapArray(_split_1)).subList(0, _minus);
      ...
      _builder.append("import ");
      _builder.append(basePackageName, "");
      _builder.append(".NetWork.HttpCaller;");
      _builder.newLineIfNotEmpty();
      _builder.append("import ");
      _builder.append(basePackageName, "");
      _builder.append(".NetWork.OkHttpCallback;");
      _builder.newLineIfNotEmpty();
      _builder.append("import ");
      _builder.append(basePackageName, "");
      _builder.append(".NetWork.Url;");
      _builder.newLineIfNotEmpty();
      _builder.append("import ");
      _builder.append(basePackageName, "");
      _builder.append(".NetWork.NameValuePair;");
      _builder.newLineIfNotEmpty();
      _builder.append("import ");
      _builder.append(basePackageName, "");
      ...
      _builder.append("import ");
      _builder.append(basePackageName, "");
      _builder.append(".Entity.MessageEvent;");
      _builder.newLineIfNotEmpty();
      _builder.append("import ");
      _builder.append(basePackageName, "");
      _builder.append(".Entity.ResponseObj;");
      _builder.newLineIfNotEmpty();
      _builder.newLine();
      _builder.append("import org.greenrobot.eventbus.EventBus;");
      _builder.newLine();
      _builder.append("import org.greenrobot.eventbus.Subscribe;");
      _builder.newLine();
      _builder.append("import org.greenrobot.eventbus.ThreadMode;");
      _builder.newLine();
      _builder.newLine();
      _builder.append("import java.io.IOException;");
      _builder.newLine();
      ...
      _builder.newLine();
      {
        for(final Api2018.HttpReqResp http : httpReqResps) {
          ...
          Record _record = http.respBody.getRecord();
          String _name_2 = _record.getName();
          String _replace = _name_2.replace("RespBody", "");
          String _firstUpper_1 = StringExtensions.toFirstUpper(_replace);
          _builder.append(_firstUpper_1, "\t");
          _builder.append("_SUCCESS = ");
          int _indexOf = httpReqResps.indexOf(http);
          ...
          _builder.append("public static final int ");
          Record _record_1 = http.respBody.getRecord();
          String _name_3 = _record_1.getName();
          String _replace_1 = _name_3.replace("RespBody", "");
          String _firstUpper_2 = StringExtensions.toFirstUpper(_replace_1);
          _builder.append(_firstUpper_2, "\t");
          _builder.append("_FAIL = ");
          int _indexOf_1 = httpReqResps.indexOf(http);
      ...
      _builder.newLine();
      _builder.append("\t");
      _builder.append("String TagName;");
      _builder.newLine();
      _builder.append("\t");
      _builder.newLine();
      {
        for(final Api2018.HttpReqResp http_1 : httpReqResps) {
          _builder.append("\t");
          _builder.append("/** ");
          Record _record_2 = http_1.respBody.getRecord();
          String _label = _record_2.getLabel();
          _builder.append(_label, "\t");
          _builder.append(" */");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("public void ");
          Record _record_3 = http_1.respBody.getRecord();
          String _method = _record_3.getMethod();
          String _lowerCase = _method.toLowerCase();
          String _firstUpper_3 = StringExtensions.toFirstUpper(_lowerCase);
          _builder.append(_firstUpper_3, "\t");
          Record _record_4 = http_1.respBody.getRecord();
          String _name_4 = _record_4.getName();
          String _replace_2 = _name_4.replace("RespBody", "");
          String _firstUpper_4 = StringExtensions.toFirstUpper(_replace_2);
          _builder.append(_firstUpper_4, "\t");
          _builder.append("(List<NameValuePair> nameValuePairs) {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("    ");
          _builder.append("Type mType = new TypeToken<");
          {
            List<Field> _fields = http_1.respBody.getFields();
            int _size = _fields.size();
            boolean _greaterThan = (_size > 0);
            if (_greaterThan) {
              _builder.append("DataResponse<");
              Record _record_5 = http_1.respBody.getRecord();
              String _name_5 = _record_5.getName();
              String _firstUpper_5 = StringExtensions.toFirstUpper(_name_5);
              _builder.append(_firstUpper_5, "\t    ");
              _builder.append(">");
            } else {
              List<Field> _fields_1 = http_1.respBodyEntity.getFields();
              int _size_1 = _fields_1.size();
              boolean _greaterThan_1 = (_size_1 > 0);
              if (_greaterThan_1) {
                _builder.append("DataResponse<");
                List<Field> _fields_2 = http_1.respBodyEntity.getFields();
                Field _get = _fields_2.get(0);
                String _type = _get.getType();
                String _firstUpper_6 = StringExtensions.toFirstUpper(_type);
                _builder.append(_firstUpper_6, "\t    ");
                _builder.append(">");
              } else {
                _builder.append("Response");
          ...
          _builder.append("\t");
          _builder.append("    ");
          _builder.append("HttpCaller.getInstance().");
          Record _record_6 = http_1.respBody.getRecord();
          String _method_1 = _record_6.getMethod();
          String _lowerCase_1 = _method_1.toLowerCase();
          String _firstUpper_7 = StringExtensions.toFirstUpper(_lowerCase_1);
          _builder.append(_firstUpper_7, "\t    ");
          _builder.append("(Url.getBaseUrl() + \"");
          Record _record_7 = http_1.respBody.getRecord();
          String _url = _record_7.getUrl();
          _builder.append(_url, "\t    ");
          _builder.append("\", mType,nameValuePairs,new OkHttpCallback() {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("        ");
          _builder.append("@Override");
          ...
          _builder.append("\t");
          _builder.append("        ");
          _builder.append("public void onFailure(int code) {");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("            ");
          _builder.append("MessageEvent messageEvent=new MessageEvent(null);");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("            ");
          _builder.append("messageEvent.setId(");
          Record _record_8 = http_1.respBody.getRecord();
          String _name_6 = _record_8.getName();
          String _replace_3 = _name_6.replace("RespBody", "");
          String _firstUpper_8 = StringExtensions.toFirstUpper(_replace_3);
          _builder.append(_firstUpper_8, "\t            ");
          _builder.append("_SUCCESS);");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("            ");
          _builder.append("messageEvent.setName(TagName);");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("            ");
          _builder.append("EventBus.getDefault().post(messageEvent);");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("        ");
          _builder.append("}");
          ...
          _builder.append("\t");
          _builder.append("        ");
          _builder.append("public void onResponse(int code, Object obj) {");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("            ");
          _builder.append("MessageEvent messageEvent = new  MessageEvent(obj);");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("            ");
          _builder.append("messageEvent.setId(");
          Record _record_9 = http_1.respBody.getRecord();
          String _name_7 = _record_9.getName();
          String _replace_4 = _name_7.replace("RespBody", "");
          String _firstUpper_9 = StringExtensions.toFirstUpper(_replace_4);
  ...
  public static CharSequence axoisapi(final Three projectThree, final List<Api2018.HttpReqResp> httpReqResps) {
    CharSequence _xblockexpression = null;
    {
      Project _project = projectThree.getProject();
      String _name = _project.getName();
      String _firstUpper = StringExtensions.toFirstUpper(_name);
      final String HttpsName = (_firstUpper + "index.js");
      Project _project_1 = projectThree.getProject();
      final String basePath = _project_1.getPath();
      Project _project_2 = projectThree.getProject();
      String _root = _project_2.getRoot();
      ...
      _builder.append("}");
      _builder.newLine();
      _builder.append("export default api");
      _builder.newLine();
      _xblockexpression = _builder;
    }
    return _xblockexpression;
  ...
  public static CharSequence axoisapi2(final Three projectThree, final List<Api2018.HttpReqResp> httpReqResps) {
    CharSequence _xblockexpression = null;
    {
      Project _project = projectThree.getProject();
      String _name = _project.getName();
      String _firstUpper = StringExtensions.toFirstUpper(_name);
      final String HttpsName = (_firstUpper + "Axois");
      Project _project_1 = projectThree.getProject();
      final String basePath = _project_1.getPath();
      Project _project_2 = projectThree.getProject();
      String _root = _project_2.getRoot();
      ...
      final String commonPackageName = IterableExtensions.join(_subList, ".");
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("import { getAction,deleteAction,putAction,postAction} from \'@/api/manage\'");
      _builder.newLine();
      _builder.newLine();
      {
        for(final Api2018.HttpReqResp http : httpReqResps) {
          ...
          Record _record_1 = http.respBody.getRecord();
          String _name_2 = _record_1.getName();
          String _replace = _name_2.replace("RespBody", "");
          String _firstLower = StringExtensions.toFirstLower(_replace);
          _builder.append(_firstLower, "");
          ...
          _builder.append("Action(\"/api/v1");
          Record _record_3 = http.respBody.getRecord();
          String _url = _record_3.getUrl();
          _builder.append(_url, "");
          _builder.append("\",params);");
          _builder.newLineIfNotEmpty();
          _builder.newLine();
      ...
      _builder.newLine();
      {
        for(final Api2018.HttpReqResp http_1 : httpReqResps) {
          _builder.append("\t");
          Record _record_4 = http_1.respBody.getRecord();
          String _name_3 = _record_4.getName();
          String _replace_1 = _name_3.replace("RespBody", "");
