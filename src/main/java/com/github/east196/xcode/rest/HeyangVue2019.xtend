...
«ELSE»
		<a-form-item
		  ...
		  «IF f.valid.toValid.valid=="cname"»
		  	{ pattern:/^[\u4e00-\u9fa5]{2,8}$/, message: '«f.label»应当使用2至8个汉字!!' },
		  «ENDIF»
		  «IF f.valid.toValid.valid=="ename"»
		  	{ pattern:/^[a-zA-Z0-9]{4,10}$/, message: '«f.label»应当使用4至10个英文、数字!!' },
		  «ENDIF»
		  «IF f.valid.toValid.valid=="address"»
		  	{ pattern:/^[\u4e00-\u9fa5A-Za-z0-9]{2,40}$/, message: '«f.label»应当使用2至40个中文、英文、数字!!' },
		  «ENDIF»
		  «IF f.valid.toValid.valid=="phone"»
		  	{ pattern:/^((17[0-9])|(14[0-9])|(13[0-9])|(15[^4,\D])|(18[0,5-9]))\d{8}$/, message: '«f.label»格式不对!!' },
		  «ENDIF»
		  «IF f.valid.toValid.valid=="password"»
		  	{ pattern:/^[a-zA-Z0-9}]{6,12}$/, message: '«f.label»应当为6至12位英文、数字!!' },
		  «ENDIF»
		  ]}"
		>
			<a-input/>
